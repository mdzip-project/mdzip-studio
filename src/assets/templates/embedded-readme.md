...
- **MDZip Studio:** open this file directly in the desktop app — it renders like a normal document, images and all.
- **VS Code:** install the [MDZip extension](https://marketplace.visualstudio.com/items?itemName=mdzip-project.mdzip-vscode) and open this file directly.
